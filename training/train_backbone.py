...
Usage:
  python training/train_backbone.py --combined          # the archive the shipped model uses
  python training/train_backbone.py --combined --epochs 15
  python training/train_backbone.py --combined --mine   # half the negatives mined, to
...
def main():
    ...
    print(
        ...
        f"  python counting/score_blind_grid.py {model_path}"
    )
