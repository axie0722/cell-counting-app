...
Usage:
  python training/train_regions.py                 # 7-fold leave-one-bird-out, then final model
  python training/train_regions.py --quick         # 1 fold, fewer epochs, for a sanity check
  python training/train_regions.py --no-augment    # ablation
"""
