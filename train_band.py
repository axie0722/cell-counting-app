...
Usage:
  python train_band.py                 # cross-bird by bird, then fit on all 14 and save
  python train_band.py --quick         # one fold, few epochs, nothing saved
  python train_band.py --no-augment    # ablation
"""
