...
Usage:
  python app_table.py                     # the table, from cached areas
  python app_table.py --areas             # compute and cache missing areas (opens TIFs)
  python app_table.py --areas --force     # recompute even where a cache exists
"""
