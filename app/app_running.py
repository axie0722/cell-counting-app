...
Usage:
  python app/app_running.py           # check the parsing, then look at this machine
"""
...
def main():
    ...
    output = (
        ...
        "12995    01-02:03:04 /usr/bin/python3 regions/draw_regions.py /Users/a/Bird_1-1-1.TIF\n"
        " 9001       02:10 /usr/bin/python3 counting/count_cells.py /Users/a/Bird_1-1-10.TIF --points\n"
    )
