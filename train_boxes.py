...
Usage:
  python train_boxes.py                 # 7-fold leave-one-bird-out, then final model
  python train_boxes.py --quick         # 1 fold, fewer epochs
  python train_boxes.py --no-augment    # ablation
"""
