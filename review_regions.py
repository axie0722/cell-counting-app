...
Usage:
  python review_regions.py
  python review_regions.py --scale 0.06     # bigger thumbnails, fewer per row

Then redraw whichever ones look wrong; draw_regions.py reloads what is already there:
  python draw_regions.py "Wh175_LH_1-1-7_NCM_Slide 3.TIF"
"""
    ...
    for section in found:
        ...
        if section["ratio"] < 0.6 * median:
            print(
                ...
                f'         python draw_regions.py "{section["image"]}"'
            )
