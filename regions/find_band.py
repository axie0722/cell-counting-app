...
Usage:
  python regions/find_band.py            # score every section on CELLS, against the null baseline
  python regions/find_band.py --pixels   # also report the pixel figures, for continuity with training
"""
