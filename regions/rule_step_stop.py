...
Usage:
  python regions/rule_step_stop.py                    # sweep the fraction, fit leave-one-bird-out
  python regions/rule_step_stop.py --fraction 0.25    # one setting, per-section detail
  python regions/rule_step_stop.py --hp               # also subtract her HP outline where one is drawn
"""
