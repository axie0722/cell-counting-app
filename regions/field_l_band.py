...
Usage:
  python regions/field_l_band.py           # shared-normal band vs independent borders, on cells
  python regions/field_l_band.py --bands   # the extracted band parameters, per section
"""
