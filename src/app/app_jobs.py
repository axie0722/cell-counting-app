...
Usage:
  python app_jobs.py "<stem>"              # run one count through the worker
  python app_jobs.py "<stem>" "<stem>" ... # run a batch, printing every signal
"""
...
def main():
    ...
    if len(sys.argv) < 2:
        raise SystemExit('usage: python app_jobs.py "<section stem>" ["<stem>" ...]')
