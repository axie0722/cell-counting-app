...
Usage:
  python review_band.py             # cross-bird, honest; refits 7 folds unless cached
  python review_band.py --final     # the all-data model, on sections it trained on
  python review_band.py --recache   # refit and overwrite the cache
"""
