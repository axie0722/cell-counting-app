...
Usage:
  python review_predicted_lines.py
  python review_predicted_lines.py --half inf@0.50     # the walk's cuts instead of the constant
  python review_predicted_lines.py --thickness 160     # a wider gap, to see which stops disappear
"""
