...
Usage:
  python rule_two_borders.py
  python rule_two_borders.py --thickness 80 --smooth 0 --black 0.005   # the shipped setting
  python rule_two_borders.py --black mask                              # the old absolute mask
"""
